...
public class GameApply {
	...
	public Integer getLeaderIdNum() {
		return leaderIdNum;
	}
	
	public void setLeaderIdNum(Integer leaderIdNum) {
	...
	public Integer getCoachIdNum() {
		return coachIdNum;
	}
	
	public void setCoachIdNum(Integer coachIdNum) {
	...
	public Integer getDoctorIdNum() {
		return doctorIdNum;
	}
	
	public void setDoctorIdNum(Integer doctorIdNum) {
